...
void							handle_signals(void (*sigint)(int),
									void (*sigquit)(int),
									void (*sigint_old)(int),
...
void							update_quote_state(int *in_quote, char *quote,
									char c);
int								check_if_have_quotes(char *str);
int								check_unclosed_quotes(const char *str);
void							update_nb_quote(char c, int *nb_quote_single,
									int *nb_quote_double);
...
int								is_alpha(char c);
t_file_redirection				*new_file_redirection(char *filename,
									t_type_of_token type);
void							add_file_redirection_back(
									t_file_redirection **head,
...
int								check_delemeter_for_sr(char *str,
									char *filename);
void							fill_heredoc_for_sr(
									t_file_redirection *heredoc);
void							loop_heredoc_for_sr(
									t_file_redirection *heredocs);
void							fill_error_codes(char **error_codes);
int								help_heredoc_sr(int *heredoc_counter,
									t_token *tokens, int error_code,
									t_file_redirection **heredocs);
int								check_heredoc_for_syntax_error(
									t_file_redirection **heredocs,
									t_token *tokens, int error_code);
